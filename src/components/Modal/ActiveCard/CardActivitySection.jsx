...
function CardActivitySection({ cardComments = [], onClickAddCardComment }) {
  ...
  const handleAddCardComment = (event) => {
    ...
    if (event.key === "Enter" && !event.shiftKey) {
      ...
      onClickAddCardComment(commentToAdd).then(() => {
        event.target.value = ""; // Clear input sau khi comment thành công
      });
    }
  };
